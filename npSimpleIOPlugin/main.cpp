...
char kMimeType[] = "application/x-simple-io-plugin";
...
nsPluginInstanceBase* NS_NewPluginInstance(
  ...
  nsPluginInstanceSimpleIO* plugin = 
    new nsPluginInstanceSimpleIO(aCreateDataStruct->instance);
...
void NS_DestroyPluginInstance(nsPluginInstanceBase * aPlugin) {
  if(aPlugin) {
    delete (nsPluginInstanceSimpleIO*)aPlugin;
  }
}
